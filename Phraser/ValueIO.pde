String ValueOut(){
  ...
  vOut[2] = String.valueOf(Vol1.getValue());
  vOut[3] = String.valueOf(Vol2.getValue());
  vOut[4] = String.valueOf(LP1.getValue());
  vOut[5] = String.valueOf(LP2.getValue());
  vOut[6] = String.valueOf(HP1.getValue());
  vOut[7] = String.valueOf(HP2.getValue());
  vOut[8] = String.valueOf(QF1.getValue());
  vOut[9] = String.valueOf(QF2.getValue());
  vOut[10] = String.valueOf(QG1.getValue());
  vOut[11] = String.valueOf(QG2.getValue());
  vOut[12] = String.valueOf(QQ1.getValue());
  vOut[13] = String.valueOf(QQ2.getValue());
